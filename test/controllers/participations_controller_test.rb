...
class ParticipationsControllerTest < ActionController::TestCase
  ...
  test "should create participation" do
    assert_difference('Participation.count') do
      post :create, participation: { attention: @participation.attention, enddate: @participation.enddate, mid: @participation.mid, pid: @participation.pid, startdate: @participation.startdate, uid: @participation.uid }
    end
  ...
  test "should update participation" do
    patch :update, id: @participation, participation: { attention: @participation.attention, enddate: @participation.enddate, mid: @participation.mid, pid: @participation.pid, startdate: @participation.startdate, uid: @participation.uid }
    assert_redirected_to participation_path(assigns(:participation))
  end
